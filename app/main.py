...
class Shell:
    def __init__(self) -> None:
        ...
        if platform.system == "Windows":
            ...
            self._readline.set_completion_display_matches_hook(self.display_matches)  # type: ignore
            self._readline.parse_and_bind("set bell-style audible")  # type: ignore
            self._readline.set_auto_history(True)  # type: ignore
        else:
